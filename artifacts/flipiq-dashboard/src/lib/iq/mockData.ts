...
export const DEAL_REVIEW_PROPERTIES: DealProperty[] = [
  {
    ...
    days: 107, dom: 107, cdom: 107, listDate: "01/16/26",
    price: "$399,000",
  ...
  },
  {
    ...
    pool: "None",
    days: 54, dom: 54, cdom: 108, listDate: "03/09/26",
    price: "$335,800",
  ...
  },
  {
    ...
    pool: "None",
    days: 131, dom: 131, cdom: 131, listDate: "12/22/25",
    price: "$895,000",
  ...
  },
  {
    ...
    beds: 4, baths: 3, garage: 2, year: 1992,
    sqft: "2,114ft²", lotSqft: "8,712ft²",
    pool: "None",
    days: 62, dom: 62, cdom: 62, listDate: "03/01/26",
    price: "$525,000",
    propensityScore: 7, propensityLabel: "Moderate Pain",
    tags: ["Absentee Owner", "High Equity (>50%)", "Tax Delinquency"],
    lastOpenDate: "04/22/26", lastOpenNote: "reopened 2 days ago",
    lastCalledDate: "N/A",
    source: "MLS", sourceStatus: "Active",
    offerPct: 15, offerLabel: "Outreach Sent",
    nextSteps: "No response — send offer",
    negotiator: "Josh Santos", assignedUser: "Josh Santos",
    statusBadge: "To do: No response — send offer", priorityBadge: "High",
  },
  {
    id: 11,
    segment: "ACTIVE_OFF_MARKET",
    ...
    textResponse: "negative",
    emailResponse: "negative",
    address: "5077 Olive Knoll Drive, Bakersfield, CA 93308",
    type: "STD",
    propertyType: "Single Family",
    beds: 3, baths: 2, garage: 2, year: 1978,
    sqft: "1,432ft²", lotSqft: "6,098ft²",
    pool: "None",
    days: 88, dom: 88, cdom: 144, listDate: "02/03/26",
    price: "$289,500",
    propensityScore: 8, propensityLabel: "Moderate Pain",
    tags: ["Long-term Owner (20+ yrs)", "High Equity (>50%)", "Code Violation"],
    lastOpenDate: "04/19/26", lastOpenNote: "reopened 5 days ago",
    lastCalledDate: "N/A",
    source: "Off Market", sourceStatus: "",
    offerPct: 15, offerLabel: "Outreach Sent",
    nextSteps: "No response — send offer",
  ...
  },
  {
    ...
    pool: "In Ground",
    days: 133, dom: 133, cdom: 179, listDate: "12/20/25",
    price: "$1,800,000",
    propensityScore: null, propensityLabel: null,
    tags: [],
    lastOpenDate: "01/01/26", lastOpenNote: "reopened 109 days ago",
  ...
  },
  {
    ...
    pool: "None",
    days: 123, dom: 123, cdom: 123, listDate: "12/30/25",
    price: "$299,000",
  ...
  },
  {
    ...
    pool: "Community",
    days: 7, dom: 7, cdom: 7, listDate: "04/25/26",
    price: "$635,000",
  ...
  },
  {
    ...
    pool: "None",
    days: 35, dom: 35, cdom: 35, listDate: "03/28/26",
    price: "$749,000",
    propensityScore: 5, propensityLabel: "No Pain",
  ...
  },
  {
    ...
    pool: "None",
    days: 9, dom: 9, cdom: 9, listDate: "04/23/26",
    price: "$65,000",
    propensityScore: 7, propensityLabel: "Moderate Pain",
  ...
  },
  {
    ...
    pool: "None",
    days: 10, dom: 10, cdom: 10, listDate: "04/22/26",
    price: "$1,350,000",
